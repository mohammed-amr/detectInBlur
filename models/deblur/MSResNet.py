...
import models.deblur.common as common
import models.deblur.ResNet as ResNet
...
class MSResNet(nn.Module):
    def __init__(self, args):
        ...
        self.body_models = nn.ModuleList([
            ResNet.ResNet(args, 3, 3, mean_shift=False),
        ])
        for _ in range(1, self.n_scales):
            self.body_models.insert(0, ResNet.ResNet(args, 6, 3, mean_shift=False))
